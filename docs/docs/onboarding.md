...
Customizations and theming applied under TERRA are available under [Apache License Version 2.0](license.md) in our [GitHub code repository](https://github.com/terra-horizon/terra-aai).
...
If you are facing a problem, check if there is a relevant [issue](https://github.com/terra-horizon/terra-aai/issues) answering your question.
